...
#### Distplots before applying changes ####

#fc_before = sns.distplot(metadata['floor_count'][metadata['floor_count'].notnull()])
#plt.show(fc_before)
#yb_before = sns.distplot(metadata['year_built'][metadata['year_built'].notnull()])
#plt.show(yb_before)
...
#### Distplots after applying changes ####

#fc_after = sns.distplot(metadata['floor_count'])
#plt.show(fc_after)
#yb_after = sns.distplot(metadata['year_built'])
#plt.show(yb_after)
